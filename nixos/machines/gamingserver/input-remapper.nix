...

{
  ...
  services.udev.extraRules = ''
    ACTION=="add", KERNEL=="[0-9]*", SUBSYSTEM=="input", ATTR{id/vendor}=="045e", ATTR{id/product}=="028e", RUN+="${pkgs.systemd}/bin/systemctl --user restart input-remapper-autoload.service"
  '';
