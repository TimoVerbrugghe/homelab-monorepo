...

{
  ...
  services.udev.extraRules = ''
    ACTION=="add", KERNEL=="input[0-9]*", SUBSYSTEM=="input", ATTRS{id/vendor}=="045e", ATTRS{id/product}=="028e", RUN+="${pkgs.systemd}/bin/systemctl --user restart input-remapper-autoload.service"
  '';
