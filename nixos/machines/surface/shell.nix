...

{
  ...
  environment.shellAliases = {
    ...
    nixupdateazure = "nixos-rebuild boot --flake github:TimoVerbrugghe/homelab-monorepo?dir=nixos#surface --refresh --impure --no-write-lock-file --max-jobs 12 --builders 'ssh://remotebuild@azurenixbuilder.azure.timo.be x86_64-linux /root/.ssh/remotebuild 1 1 nixos-test,benchmark,big-parallel,kvm - -'";
    nixupdategamingserver = "nixos-rebuild boot --flake github:TimoVerbrugghe/homelab-monorepo?dir=nixos#surface --refresh --impure --no-write-lock-file --max-jobs 12 --builders 'ssh://remotebuild@gamingserver.local.timo.be x86_64-linux /root/.ssh/remotebuild 1 1 nixos-test,benchmark,big-parallel,kvm - -'";
    k = "kubectl";
    t = "talosctl";  
  };
