  ...
  systemd.services.target-setup = {
    ...
    script = ''
      ...
      ${pkgs.targetcli}/bin/targetcli <<EOF
        ...
        /iscsi create iqn.2025-12.be.timo.local.odd:iscsi-test
        /iscsi/iqn.2025-12.be.timo.local.odd:iscsi-test/tpg1/luns create /backstores/fileio/iscsi-test
        /iscsi/iqn.2025-12.be.timo.local.odd:iscsi-test/tpg1/acls create iqn.2005-03.org.open-iscsi:*
        /iscsi/iqn.2025-12.be.timo.local.odd:iscsi-test/tpg1 set attribute authentication=0 demo_mode_write_protect=0 generate_node_acls=1 cache_dynamic_acls=1
        saveconfig
        exit
      EOF
    '';
